...
class CompanyOfferAdapter(val context: Context, var offerList: ArrayList<Offer>, var company_logos: ArrayList<Bitmap>, var company_names: ArrayList<String>): RecyclerView.Adapter<CompanyOfferAdapter.OfferViewHolder>() {
